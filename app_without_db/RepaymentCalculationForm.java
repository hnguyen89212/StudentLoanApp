 ...
 * Program      : RepaymentCalculationForm.java
 * Description  : A form to input "current annual interest rate" and "amortization periods in months" to calculate payments.
 * Dependencies : Student.java, StudentLoanApp.java, HN_LoanTools.java, HN_LoanPayable.java, HN_NegativeValueException.java
 */
...
public class RepaymentCalculationForm extends JFrame {
    ...
    /**
     * Displays personal information of current student (determined by "index") to the frame.
     */
    ...
    /**
     * Enables/disables scrolling/switching buttons based on "index".
     * For example, if the first student is shown, disable "previousBtn".
     */
    ...
    // ------------------------------------------
    /**
     * Triggered when previous student is needed
     * (previousBtn is clicked)
     */
    ...
    /**
     * Triggered when next student is needed
     * (nextBtn is clicked)
     */
    ...
    /**
     * Triggered when clearing form is needed
     * (clearBtn is clicked)
     */
    ...
    /**
     * Triggered when calculation is needed
     * (calculateBtn is clicked)
     */
